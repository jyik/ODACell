...
class D_CRIMP(Dobot):
    ...
    def get_electrolyte(self, cell_holder='Active Site'):
        ...
        self.mov('l', get_pnt('Dobie Crimp Inside Otto', self.coord))
        self.command.Sync()
    ...
    def load_crimper(self, cell_holder='Active Site'):
        ...
        self.mov('j', get_pnt('Dobie Crimp in Front of Crimper - Loaded', self.coord))
        ...
        self.mov('l', get_pnt('Dobie Crimp in Front of Crimper - Unloaded', self.coord))
        self.dashboard.SpeedFactor(self.default_speed)
        self.mov('j', get_pnt('Dobie Crimp Crimping Intermediate', self.coord))
        self.command.Sync()
    ...
    def home(self):
        ...
        self.mov('j', get_pnt('Dobie Crimp Home', self.coord))
        self.command.Sync()

    def collect_pos_components(self, row_id, ref_h=50.0):
        place_pnt = get_pnt('Dobie Crimp Component Placement in Active Site', self.coord)
        self.pick_n_place(get_pnt('Cell {}: P casing'.format(row_id), self.coord), place_pnt, ref_h)
        self.pick_n_place(get_pnt('Cell {}: cath'.format(row_id), self.coord), place_pnt, ref_h)
        self.home()