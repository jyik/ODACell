...
class D_CRIMP(Dobot):
    ...
    def load_crimper(self, cell_holder='Active Site'):
        ...
        self.mov('l', get_pnt('Dobie Crimp Over Crimper Hole - Loaded', self.coord), False, ("CP=0", "SpeedL=15"))
        self.mov('l', get_pnt('Dobie Crimp Over Crimper Hole - Unloaded', self.coord), False, ("CP=0", "SpeedL=15"))
        self.mov('l', get_pnt('Dobie Crimp in Front of Crimper - Unloaded', self.coord), True, ("CP=0", "SpeedL=15"))
    ...
    def unload_crimper(self, return_cellholder='Active Site'):
        ...
        self.mov('l', get_pnt('Dobie Crimp Over Crimper Hole - Unloaded', self.coord), False, ("CP=0", "SpeedL=15"))
        self.command.RelMovL(0,0,6.0)
        for _ in range(10):
            self.command.RelMovL(0.1,-0.3,0.3,('CP=0', 'AccL=100', 'SpeedL=100'))
            self.command.RelMovL(-0.1,0.3,0.3,('CP=0', 'AccL=100', 'SpeedL=100'))
            self.command.RelMovL(0,0,-0.15,('CP=0', 'AccL=100', 'SpeedL=100'))
        self.mov('l', get_pnt('Dobie Crimp Over Crimper Hole - Loaded', self.coord), False, ("CP=0", "SpeedL=15"))
        self.mov('l', get_pnt('Dobie Crimp in Front of Crimper - Loaded', self.coord), False, ("CP=0", "SpeedL=15"))
        self.mov('j', get_pnt('Dobie Crimp Crimping Intermediate', self.coord))
        if return_cellholder=='Active Site':
            self.return_cellholder()
