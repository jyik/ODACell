...
from robot_class_v2 import Dobbie_Cell, Dobbie_Crimp, OT2, Dobbie_Grip
import time
import threading
import socket
import os
    ...
    while serverRunning:
        if len(Queue) > 0:
            ...
            if "makeCell" in command.split():
                #Check for cells that have finished cycling first and remove them
